...
$(function() {
  ...
  // KBW-Countdown End
  // --------------------------------------------- //
  const download = document.getElementById('notify-trigger');
  download.addEventListener('click', request);

  function request() {
    window.open('downloads/exclusivine.pdf');
  }
  // --------------------------------------------- //
  ...
  $('.notify-form').ajaxChimp({
    ...
    url:
      'https://besaba.us10.list-manage.com/subscribe/post?u=e8d650c0df90e716c22ae4778&amp;id=54a7906900'
  });
